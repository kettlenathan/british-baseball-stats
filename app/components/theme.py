...
STAT_LABELS = {
    ...
    # The "+ vs Div" pair is deliberately labelled as a comparison against a
    # different baseline, not as a different statistic: wrc_plus measures a
    # hitter against the whole competition, wrc_plus_div against the division
    # they actually played in. See stats/league_context.py for why both exist.
    ...
    "shrunk_woba_sd": "Uncertainty", "prior_woba": "Prior wOBA",
...
STAT_FORMAT = {
    ...
    "reliability": ".0%", "shrunk_woba_sd": ".3f", "prior_woba": ".3f",
